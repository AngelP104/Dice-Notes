export const SesionCardEnCurso = ({ sesion, onClick }) => (
    <div
        onClick={() => onClick(sesion.id)}
        className="flex flex-col md:flex-row justify-between items-start md:items-center bg-emerald-600/60 hover:bg-emerald-500/60 border-emerald-400 border-2 p-4 rounded-lg transition duration-200 space-y-4 md:space-y-0 md:space-x-6 mb-4 cursor-pointer"
    >
        <div className="flex flex-col md:flex-row md:items-center md:space-x-6 w-full">
            ...
            <div className="flex flex-col text-sm text-gray-300 mt-2 md:mt-0">
